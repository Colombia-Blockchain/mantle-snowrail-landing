 ...
 * Includes: Hero, Logos, How it works, Bento benefits, Trust, Use cases, Devs, Testimonials, FAQ, CTA, Footer
 */
...
const DICTIONARY = {
  en: {
    ...
    hero: {
      ...
      proof:
        'Designed for regulated flows • Idempotent intents • Webhook signed events',
    },
    logos: {
      ...
      endpoints: [
        {
          method: 'POST',
          path: '/v1/intents',
          desc: 'Create an idempotent payment intent',
        },
        {
          method: 'GET',
          path: '/v1/intents/{id}',
          desc: 'Fetch intent status + timeline',
        },
        {
          method: 'POST',
          path: '/v1/intents/{id}/route',
          desc: 'Trigger routing / settlement',
        },
        {
          method: 'POST',
          path: '/v1/webhooks',
          desc: 'Register signed webhooks',
        },
      ],
    ...
    footer: {
      rights: '© 2026 SnowRail. Crypto→Fiat payment infrastructure with x402.',
      compliance:
        'Designed for regulated flows • Security-first • Audit-friendly',
  ...
  es: {
    ...
    hero: {
      ...
      headlineB: 'Fiat sale.',
      subhead:
        'SnowRail es infraestructura de pagos que enruta stablecoins hacia rails bancarios con intents x402, webhooks, conciliación y hooks de compliance—hecho para flujos regulados y velocidad de integración.',
      cta: 'Solicitar demo',
      secondary_cta: 'Leer docs',
      tertiary_cta: 'Ver demo (90s)',
      proof:
        'Diseñado para flujos regulados • Intents idempotentes • Eventos firmados por webhooks',
    },
    logos: {
      ...
      steps: [
        {
          ...
          body: 'Define pagador, monto, moneda y restricciones de política. Obtén un intent_id idempotente y un timeline de estados.',
        },
        {
          icon: 'route',
          title: 'Enruta a rails',
          body: 'SnowRail elige la mejor ruta (stablecoin → rails) según disponibilidad, costo y políticas de riesgo.',
        },
        {
          icon: 'settle',
          title: 'Liquida + concilia',
          body: 'El dinero llega en fiat y recibes webhooks firmados + vista de ledger para auditoría y conciliación.',
        },
      ],
    },
    benefits: {
      kicker: 'Por qué SnowRail',
      title: 'Hecho para conversión, compliance y velocidad.',
      cards: {
        big: {
          ...
          meta: 'Flujo típico: intent → route → settle → reconcile',
        },
        reconciliation: {
          title: 'Conciliación + ledger',
          body: 'Vista unificada de intents, payouts y settlement bancario—sin operaciones fragmentadas.',
          meta: 'Logs listos para auditoría',
        },
        webhooks: {
        ...
        policies: {
          ...
          body: 'Integra KYC/AML, reglas de riesgo, límites y allowlists. Bloquea o enruta según compliance.',
          meta: 'Checks componibles',
        },
        devux: {
          title: 'Developer UX first',
          body: '3–5 líneas para integrar. SDKs limpios, errores claros, modo sandbox.',
          meta: 'Docs + ejemplos',
        },
        uptime: {
          title: 'Observabilidad & SLA',
          body: 'Endpoints de estado, trazas y retries deterministas pensados para producción.',
    ...
    trust: {
      kicker: 'Confianza',
      title: 'Seguridad y compliance desde el diseño.',
      bullets: [
        'Intents idempotentes + retries deterministas',
        'Webhooks firmados (HMAC) y protección anti-replay',
        'Audit logs y rastro de conciliación exportable',
        'Hooks de policy para KYC/AML y riesgo',
        'Cifrado en tránsito y en reposo',
        'Separación de responsabilidades: llaves, políticas y settlement',
      ],
    ...
    useCases: {
      kicker: 'Casos de uso',
      title: 'Dónde SnowRail genera impacto',
      items: [
        {
          icon: 'marketplace',
          title: 'Payouts para marketplaces',
          body: 'Paga vendedores globalmente recibiendo stablecoins. Menos soporte gracias a estados + conciliación.',
          metric: 'Menos fallas, settlement rápido',
        },
        {
          icon: 'payroll',
          title: 'Nómina global',
          body: 'Automatiza pagos a contractors con checks de policy y eventos de settlement.',
          metric: 'Minutos, no días',
        },
        {
          icon: 'checkout',
          title: 'Checkout crypto → fiat',
          body: 'Acepta stablecoins en checkout y liquida a tu cuenta bancaria con webhooks.',
          metric: 'Más conversión, menos fricción',
        },
        {
          icon: 'invoicing',
          title: 'Facturación cross-border',
          body: 'Cobra en stablecoins, liquida a rails fiat y concilia automáticamente.',
    ...
    dev: {
      ...
      title: 'Integra hoy. Escala mañana.',
      desc: 'Crea intents, suscríbete a eventos y liquida a rails fiat. Primitivas claras, superficie mínima.',
      ...
      endpoints: [
        {
          method: 'POST',
          path: '/v1/intents',
          desc: 'Crear intent de pago idempotente',
        },
        {
          method: 'GET',
          path: '/v1/intents/{id}',
          desc: 'Ver estado + timeline del intent',
        },
        {
          method: 'POST',
          path: '/v1/intents/{id}/route',
          desc: 'Disparar routing / settlement',
        },
        {
          method: 'POST',
          path: '/v1/webhooks',
          desc: 'Registrar webhooks firmados',
        },
      ],
    ...
    testimonials: {
      kicker: 'Prueba',
      title: 'Hecho para equipos que envían pagos',
      items: [
        {
          quote:
            'El modelo de intents volvió predecible nuestro flujo crypto→fiat. Por fin tuvimos estados, retries y conciliación.',
          name: 'Head of Payments',
          company: 'Fintech (Privado)',
        },
        {
          quote:
            'Webhooks firmados + audit logs le dieron confianza a compliance sin frenar ingeniería.',
          name: 'Engineering Lead',
          company: 'Marketplace (Privado)',
        },
        {
          quote:
            'Integrar payouts se sintió como usar una API moderna: mínimo setup, errores claros y iteración rápida.',
          name: 'Senior Developer',
    ...
    faq: {
      ...
      items: [
        {
          q: '¿Cómo manejan compliance (KYC/AML) y auditoría?',
          a: 'SnowRail soporta hooks de policy y un rastro de eventos: integras tus proveedores de KYC/AML/riesgo y exportas logs de conciliación para auditorías.',
        },
        {
          q: '¿Qué tan rápido es el settlement a fiat?',
          a: 'Depende de rails y región, pero SnowRail está diseñado para routing rápido y retries deterministas con updates en tiempo real vía webhooks.',
        },
        {
          q: '¿Soportan idempotencia y retries seguros?',
          a: 'Sí. Los intents son idempotentes por defecto y la plataforma usa transiciones de estado predecibles y webhooks a prueba de replay.',
        },
        {
          q: '¿Cómo es la integración?',
          a: 'Creas un intent, lo enrutas y te suscribes a eventos. La mayoría de equipos integra en un día con SDK + ejemplos.',
        },
        {
          q: '¿Hay sandbox?',
          a: 'Sí. Sandbox para probar intents, routing y webhooks sin tocar rails productivos.',
        },
      ],
    },
    finalCta: {
      title: '¿Listo para enrutar pagos crypto→fiat?',
      sub: 'Solicita una demo para ver el flujo x402, timeline de settlement y conciliación en acción.',
      primary: 'Solicitar demo',
      secondary: 'Leer docs',
    },
    footer: {
      rights: '© 2026 SnowRail. Infraestructura de pagos Crypto→Fiat con x402.',
      compliance:
        'Diseñado para flujos regulados • Security-first • Audit-friendly',
      built_on: 'API • Webhooks • Intents • Routing • Settlement',
    },
  },
}
...
// -----------------------------
// 2) UTIL: reveal on scroll (no GSAP required)
// -----------------------------
...
const Starfield = ({ disabled }) => {
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      // rebuild particles to fit new size
...
const SpotlightLink = ({ children, href, onClick }) => {
...
const SectionHeader = ({ kicker, title, center = false, desc }) => (
  <div className={`${center ? 'text-center' : ''} mb-10`} data-reveal>
    ...
    {desc ? (
      <p className="mt-3 text-gray-300/80 max-w-2xl mx-auto">{desc}</p>
    ) : null}
  </div>
)
...
export default function App() {
  ...
  const personas = {
    cfo: {
      ...
      head:
        lang === 'en'
          ? 'Unified payments visibility'
          : 'Visibilidad unificada de pagos',
      body:
        lang === 'en'
          ? 'One timeline for intents, settlements, and reconciliation—built for audit and reporting.'
          : 'Un solo timeline para intents, settlement y conciliación—listo para auditoría y reporting.',
    },
    founder: {
      ...
      head:
        lang === 'en'
          ? 'Ship global payouts fast'
          : 'Lanza payouts globales rápido',
      body:
        lang === 'en'
    ...
    dev: {
      ...
      head:
        lang === 'en'
          ...
          : 'API-first, superficie mínima',
      body:
        lang === 'en'
          ? 'Create an intent, route it, receive signed webhooks. That’s the whole model.'
          : 'Crea un intent, enrútalo, recibe webhooks firmados. Ese es el modelo.',
    },
    partner: {
      label: lang === 'en' ? 'Partners' : 'Partners',
      icon: <Layers />,
      head:
        lang === 'en' ? 'Composable integrations' : 'Integraciones componibles',
      body:
        lang === 'en'
  ...
  return (
    ...
    >
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8" data-reveal>
            ...
            <h1 className="text-5xl md:text-7xl font-bold leading-[1.05] tracking-tight">
              {t.hero.headlineA}{' '}
              <span className="shimmer-text">{t.hero.headlineB}</span>
            </h1>
          ...
          >
            ...
            <GlassCard className="absolute top-10 left-6 w-44 p-4 z-10 float-7">
              ...
              <div className="text-sm text-gray-300/80">
                created → routed →{' '}
                <span className="text-white font-semibold">settled</span>
              </div>
            ...
            <GlassCard className="absolute bottom-40 left-16 w-48 p-4 z-10 float-7">
              ...
              <div className="text-sm text-gray-300/80">
                ledger view + exportable audit logs
              </div>
              <div className="text-[11px] text-gray-500 mt-2 font-mono">
                trace_id: enabled
              </div>
      ...
      <section id="product" className="relative py-20 px-6 z-10 scroll-mt-24">
        <div className="max-w-5xl mx-auto">
          <SectionHeader
            ...
            title={
              lang === 'en'
                ? 'See the intent timeline'
                : 'Mira el timeline de intents'
            }
            center
          />
            ...
            <div className="flex flex-col md:flex-row gap-8">
              <div className="flex md:flex-col gap-2 overflow-x-auto pb-4 md:pb-0 md:w-64 shrink-0">
                {Object.keys(personas).map((key) => (
                  ...
                  >
                    <span className="font-medium">{personas[key].label}</span>
                    <div
                    ...
                    {activePersona === 'dev' && (
                      <div className="mt-8 p-4 rounded-lg bg-black/50 font-mono text-sm border border-white/10">
                        ...
                        <div className="text-purple-300">
                          ...
                          <span className="text-yellow-200">snowrail</span>
                          .intents.create(
                          {'{'}
                          <br />
                          &nbsp;&nbsp;amount:{' '}
                          <span className="text-green-300">"2500.00"</span>,
                          <br />
                          &nbsp;&nbsp;currency:{' '}
                          <span className="text-green-300">"USD"</span>,<br />
                          &nbsp;&nbsp;source:{' '}
                          <span className="text-green-300">"USDC"</span>,<br />
                          &nbsp;&nbsp;destination:{' '}
                          <span className="text-green-300">"BANK_RAILS"</span>,
                          <br />
                          &nbsp;&nbsp;idempotency_key:{' '}
          ...
          <div className="grid lg:grid-cols-12 gap-4">
            ...
            <GlassCard className="p-8 lg:col-span-5" hover data-reveal>
              ...
              <h3 className="text-2xl font-bold mb-3">
                {t.benefits.cards.reconciliation.title}
              </h3>
            ...
            <GlassCard className="p-7 lg:col-span-4" hover data-reveal>
              ...
              <h3 className="text-xl font-bold mb-2">
                {t.benefits.cards.webhooks.title}
              </h3>
              <p className="text-gray-300/80 leading-relaxed">
                {t.benefits.cards.webhooks.body}
              </p>
              <div className="mt-4 text-xs text-gray-500">
                {t.benefits.cards.webhooks.meta}
              </div>
            </GlassCard>
            ...
            <GlassCard className="p-7 lg:col-span-4" hover data-reveal>
              ...
              <h3 className="text-xl font-bold mb-2">
                {t.benefits.cards.policies.title}
              </h3>
              <p className="text-gray-300/80 leading-relaxed">
                {t.benefits.cards.policies.body}
              </p>
              <div className="mt-4 text-xs text-gray-500">
                {t.benefits.cards.policies.meta}
              </div>
            </GlassCard>
            ...
            <GlassCard className="p-7 lg:col-span-4" hover data-reveal>
              ...
              <h3 className="text-xl font-bold mb-2">
                {t.benefits.cards.devux.title}
              </h3>
              <p className="text-gray-300/80 leading-relaxed">
                {t.benefits.cards.devux.body}
              </p>
              <div className="mt-4 text-xs text-gray-500">
                {t.benefits.cards.devux.meta}
              </div>
            </GlassCard>
            ...
            <GlassCard className="p-7 lg:col-span-12" hover data-reveal>
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                  ...
                  <h3 className="text-xl font-bold mb-2">
                    {t.benefits.cards.uptime.title}
                  </h3>
                  <p className="text-gray-300/80 leading-relaxed">
                    {t.benefits.cards.uptime.body}
                  </p>
                  <div className="mt-3 text-xs text-gray-500">
                    {t.benefits.cards.uptime.meta}
                  </div>
                </div>
      ...
      <section
        id="developers"
        className="relative py-20 px-6 z-10 scroll-mt-24"
      >
            ...
            <div className="rounded-2xl overflow-hidden bg-[#0f0f1e] border border-white/10 shadow-2xl">
              ...
              <div className="p-6 font-mono text-sm space-y-4">
                <div>
                  ...
                  <span className="text-cyan-300">~</span> npm install
                  @snowrail/sdk
                  <div className="text-gray-500 text-xs mt-1">
                    added 18 packages in 1.1s
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="text-gray-300 mt-2 leading-relaxed">
                    ...
                    <br />
                    <span className="text-cyan-300">[Webhook]</span>{' '}
                    intent.settled (signed)
                  </div>
                </div>
            ...
            {t.faq.items.map((item, idx) => {
              ...
              return (
                <GlassCard key={idx} className="p-0" data-reveal>
                  ...
                  {open && (
                    <div className="px-6 pb-6 text-gray-300/85 leading-relaxed">
                      {item.a}
                    </div>
                  )}
                </GlassCard>
          ...
          <GlassCard className="p-10 md:p-14 border-cyan-400/20">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
              <div>
                ...
                <p className="mt-3 text-gray-300/80 max-w-2xl">
                  {t.finalCta.sub}
                </p>
            ...
            <GlassCard className="p-0 overflow-hidden border-white/15">
              <div className="flex items-center justify-between px-5 py-4 border-b border-white/10 bg-white/[0.05]">
                <div className="text-sm font-bold">
                  {lang === 'en'
                    ? 'SnowRail Demo (placeholder)'
                    : 'Demo SnowRail (placeholder)'}
                </div>
                <button
              ...
              {/* Replace this placeholder with an actual embed (YouTube/Vimeo) */}
                ...
                <div className="text-center px-6">
                  ...
                  <div className="text-lg font-bold mb-2">
                    {lang === 'en'
                      ...
                      : 'Agrega un embed real para máxima conversión.'}
                  </div>
...
/** Small icon component to avoid importing another lucide icon */
function CoinsIcon() {
  return (
    <svg
      width="18"
